  ...
  <div>
    <div class="doc-index-page" v-if="init">
      ...
      <div class="book-intro-cat">
        ...
        <a :href="'/pages/details/doc-menu/main?id='+doc.id" class="book-detail-bar">
          <div class="book-meta-l">
            <span class="menu">查看目录</span>
            <span class="pages">共{{doc.page_count}}章</span>
          </div>
          <div class="book-meta-r" v-if="doc.last_update">
            更新于{{doc.last_update.updated_format}}
